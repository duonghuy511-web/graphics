...
const ALL_PRODUCTS: Product[] = [
  ...
  { id: 5, name: "VELOX GUM-V", categoryId: "da-bong", categoryVi: "Giày Đá Bóng", price: 2190000, tag: "HOT", img: IMG.p5, desc: "Đinh TF bám sân nhân tạo, kiểm soát bóng chính xác với da tổng hợp cao cấp.", sizes: ["39","40","41","42","43"], rating: 4, reviews: 52 },
  { id: 6, name: "VELOX STRIKE", categoryId: "cau-long", categoryVi: "Giày Cầu Lông", price: 1790000, tag: null, img: IMG.p6, desc: "Siêu nhẹ chỉ 220g, ôm chân hoàn hảo, hỗ trợ chuyển hướng tức thì.", sizes: ["38","39","40","41","42","43"], rating: 5, reviews: 41 },
