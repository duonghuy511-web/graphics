...
import p2Image from '@/image/VELOX-DOMINATOR.jpg';
import p3Image from '@/image/VELOX-STREAK.jpg';
...
───────────────────────────────────────────── */
const IMG = {
  hero: "https://images.unsplash.com/photo-1744060204728-f68e434a3edf?w=900&h=1200&fit=crop&auto=format",
...
const ALL_PRODUCTS: Product[] = [
  ...
  { id: 2, name: "VELOX DOMINATOR", categoryId: "bong-ro", categoryVi: "Giày Bóng Rổ", price: 2990000, tag: "BÁN CHẠY", img: IMG.p2, desc: "Công nghệ đệm ProFoam™ phân tán lực tác động, bảo vệ khớp trong mọi bài tập.", sizes: ["38","39","40","41","42","43","44"], rating: 5, reviews: 214 },
  ...
  { id: 4, name: "VELOX GLIDE", categoryId: "cau-long", categoryVi: "Giày Cầu Lông", price: 1590000, tag: "MỚI", img: IMG.p4, desc: "Phong cách tối giản, linh hoạt từ gym ra đường phố với thiết kế đa năng.", sizes: ["38","39","40","41","42","43","44","45"], rating: 4, reviews: 63 },
  { id: 5, name: "VELOX GUM-V", categoryId: "truot-van", categoryVi: "Giày Trượt Ván", price: 2190000, tag: "HOT", img: IMG.p5, desc: "Đinh TF bám sân nhân tạo, kiểm soát bóng chính xác với da tổng hợp cao cấp.", sizes: ["39","40","41","42","43"], rating: 4, reviews: 52 },
  { id: 6, name: "VELOX STRIKE", categoryId: "da-bong", categoryVi: "Giày Đá Bóng", price: 1790000, tag: null, img: IMG.p6, desc: "Siêu nhẹ chỉ 220g, ôm chân hoàn hảo, hỗ trợ chuyển hướng tức thì.", sizes: ["38","39","40","41","42","43"], rating: 5, reviews: 41 },
  { id: 7, name: "VELOX Grind", categoryId: "truot-van", categoryVi: "Giày Trượt Ván", price: 1690000, tag: null, img: IMG.p7, desc: "Đế cao su vulcanized 6mm chống mài mòn, bo mũi và gót tăng độ bền.", sizes: ["38","39","40","41","42","43","44"], rating: 4, reviews: 33 },
  { id: 8, name: "VELOX Summit", categoryId: "leo-nui", categoryVi: "Giày Leo Núi", price: 2790000, tag: "MỚI", img: IMG.p8, desc: "Chống thấm nước GORE-TEX, đế Vibram bám đá, cổ cao bảo vệ mắt cá.", sizes: ["39","40","41","42","43","44"], rating: 5, reviews: 29 },
  { id: 9, name: "VELOX Court King", categoryId: "bong-ro", categoryVi: "Giày Bóng Rổ", price: 2590000, tag: "HOT", img: IMG.p9, desc: "Cổ cao bảo vệ mắt cá, đệm khí Full-Air giảm chấn cực đại.", sizes: ["40","41","42","43","44","45"], rating: 5, reviews: 76 },
  { id: 10, name: "VELOX Apex Trainer", categoryId: "gym", categoryVi: "Giày Tập Gym", price: 2290000, tag: null, img: IMG.p10, desc: "Đế phẳng ổn định cho Squat và Deadlift, hỗ trợ mắt cá tối đa.", sizes: ["39","40","41","42","43","44"], rating: 4, reviews: 91 },
  { id: 11, name: "VELOX Classic Low", categoryId: "pho-thong", categoryVi: "Giày Phổ Thông", price: 1500000, tag: null, img: IMG.p11, desc: "Thiết kế cổ điển không bao giờ lỗi mốt, da PU cao cấp dễ vệ sinh.", sizes: ["38","39","40","41","42","43","44","45"], rating: 4, reviews: 155 },
  { id: 12, name: "VELOX Storm Runner", categoryId: "chay-bo", categoryVi: "Giày Chạy Bộ", price: 2890000, tag: "BÁN CHẠY", img: IMG.p12, desc: "Chống nước nhẹ, đế carbon plate tăng lực đẩy cho runner nghiêm túc.", sizes: ["38","39","40","41","42","43"], rating: 5, reviews: 182 },
];
